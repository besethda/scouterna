...
const Union = () => {
    ...
    return (
        <div className="pt-3 pb-10 w-full bg-bg-blue md:px-18 md:py-18">
            <ContentSection
                sectionLayout={["t", "p"]}
                page="union"
                background={"blue"}
                padding="top"
            />
            <div className="pt-7 px-4 bg-bg-blue flex flex-col items-center gap-2 font-albert text-text-black md:gap-9">
                <div className="w-full lg:max-w-430 lg:px-22">
