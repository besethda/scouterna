export type MessagesEngType = {
  ...
  division: {
    ...
    upptackascouter_title: string,
    upptackascouter_ages: string,
    upptackascouter_day: string,
    upptackascouter_time: string,
    upptackascouter_place: string,
    upptackascouter_paragraph: string,
...
export const En: MessagesEngType = {
  ...
  division: {
    ...
    upptackascouter_title: "Upptäckascouter",
    upptackascouter_ages: "10-11 Years",
    upptackascouter_day: "Tuesday",
    upptackascouter_time: "18:00",
    upptackascouter_place: "Ruffen",
    upptackascouter_paragraph: "You do more sailing and longer excursions in the archipelago. The Kaparna take on more responsibility, learn the basics of navigation and build friendships that last far beyond the scout corps.",
  ...
  breadcrumbs: {
    ...
    page: {
      ...
      upptackascouter: "Upptäckascouter",
      utmanare: "Utmanare",
  ...
  tabTitle: {
    ...
    upptackascouter: "HSS | Upptäckascouter",
  ...
  description: {
    ...
    upptackascouter: "Upptäckascouter - Discoverer Scouts ages 10-11 at Hässelby Strands Sjöscouter (HSS) 🚤🏕️ | More sailing, longer archipelago trips, and navigation basics | Take more responsibility - practical tasks from knife/axe to first aid and cooking | Friendship for life | Tuesdays at Ruffen | Become a Kapare here",
 ...
 email: {
  ...
  GroupKaparna: {
    headline: "Groups", 
    title: "Upptäckascouter",
    text: "At Upptäckascouter, the difficulty level of the tasks is stepped up. The scouts learn to sail the Optimist dinghy and also get to try sailing a 2-Krona and a keelboat. A fully trained Explorer Scout is capable of handling a knife, building and extinguishing small fires, sailing an Optimist on their own, and possesses basic skills in first aid and maritime safety",
  },
  GroupKonvojen: {
    headline: "Groups", 
