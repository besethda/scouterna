...
export const Sv: MessagesSvType = {
  ...
  description:{
    history: "Historia sidan",
    "become-a-scout": "Bli Sjöscout sidan",
    faq: "FAQ sidan",
    "groups": "Våra avdelningar sidan",
    sjohumlorna: "Sjöhumlorna sidan",
    kaparna: "Kaparna sidan",
    konvojen: "Konvojen sidan",
    utmanare: "Utmanare sidan",
    familjescouter: "Familjescouter sidan",
    lifestyle: "Livet som Sjöscout sidan",
    boats: "Båtar sidan",
    cabins: "Scoutstugor sidan",
    myset: "Myset sidan",
    ruffen: "Ruffen sidan",
    members: "För medlemmar sidan",
    information: "Information för medlemmar sidan",
    safety: "Flytvästpolicy sidan",
