...
export const Sv: MessagesSvType = {
  ...
  division: {
    ...
    upptackascouter_ages: "10-11 år",
    upptackascouter_day: "Tisdag",
    upptackascouter_time: "18:00",
    upptackascouter_place: "Ruffen",
    upptackascouter_paragraph: "Nu blir det mer segling och längre utflykter i skärgården. Upptäckascouter tar mer ansvar, lär sig grunderna i navigation och bygger vänskap som varar långt utanför scoutkåren.",
  ...
  description: {
    ...
    upptackascouter: "Upptäckascouter - 10-11 år hos HSS 🚤 | Segling, navigation, ansvar & vänskap | Märken: kniv, yxa, eld, sjukvård | Tisdagar vid Ruffen | Bli Upptäckarscout",
