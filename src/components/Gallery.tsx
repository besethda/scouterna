...
const Gallery = ({type="instagram", photoObject}:{type?:string, photoObject: instaType[]}) => {
  ...
  return (
    <div className="flex">
            ...
            {currentImages.map(image => <a href={photoObject[image].permalink} className="relative w-[60%] mx-[1.5%] hover:brightness-110 duration-150" key={photoObject[image].timestamp}>
