...
const Navigation = ({ onClose }: NavigationProps) => {
    ...
    return (
        <div className={`absolute lg:static w-full bg-white text-primary rounded-b-lg font-albert tracking-[0.03em] top-16 md:top-29 lg:bg-primary lg:h-25.5 lg:text-text-white-white lg:text-lg lg:rounded-none ${isScroll ? "lg:bg-primary/80" : ""}`}>
