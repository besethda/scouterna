        ...
        <div className="bg-white rounded-b-lg font-albert tracking-[0.03em] lg:bg-primary lg:h-25.5 lg:text-white lg:text-lg lg:flex lg:justify-around lg:items-center lg:rounded-none">
            {menuList.map((menu, index) => (
                <div key={index}>
                    ...
                    {openId === menu.id && (
                        <div onClick={() => handleToggle(menu.id)} className="px-2 py-4 pt-10 border-b border-lightGray lg:py-0 lg:bg-white lg:text-black lg:w-87.5 lg:pt-0 lg:absolute lg:top-25.5 lg:border-none">
