      ...
      <div className="pb-25 px-4 w-full md:px-17 md:max-w-200 lg:max-w-430">
        ...
        <div className="">
          <div className="flex justify-between items-center mt-4 mb-4 mx-[1.5%]">
            ...
            <a href="https://www.instagram.com/hss_scout/" className="font-albert bg-primary hover:bg-[#0D3F6A] active:bg-[#2D4D6B] active:scale-95 duration-150 h-fit text-white text-acc-desktop md:text-button-desktop py-2 px-5 rounded-3xl">{messages?.instagram.button_text}</a>
          </div>
          <div className="flex">
