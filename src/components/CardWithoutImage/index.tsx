...
const CardWithoutImage = ({ headline, logo, title, text, MDlogo }: CardWithoutImageProps) => {
  return (
    <>
      <div className="flex flex-col md:flex-row w-full pt-5 px-4 pb-10 lg:max-w-430 lg:px-22 md:flex md:pt-12.5 md:pb-16 md:px-50 md:items-start gap-6 md:gap-25 items-center ">
