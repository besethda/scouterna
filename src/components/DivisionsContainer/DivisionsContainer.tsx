...
const DivisionsContainer = () => {
  ...
  return (
    <div className="w-full md:max-w-200 lg:max-w-430"> 
      ...
      <div className="text-h2 font-varela md:text-h2-desktop text-primary mt-15 lg:px-22 px-5 w-full md:max-w-200 lg:max-w-430">{messages?.home.divisions_family_title}</div>
      <div className="px-5 text-body font-albert md:text-body-desktop lg:px-22 text-text-black w-full md:max-w-200 lg:max-w-430">{messages?.division.familjescouter_paragraph}</div>
