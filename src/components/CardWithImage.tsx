...
const CardWithImage = ({ sectionTitle, logo, image }: CardWithImageProps) => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row w-full lg:min-w-180 pt-5 px-4 pb-10 md:flex md:pt-12.5 md:pb-8 lg:pb-12 lg:items-start gap-6 md:gap-25 items-center lg:max-w-430">
