...
const CardWithImage = ({ sectionTitle, logo, image }: CardWithImageProps) => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row w-full pt-5 px-4 pb-10 md:flex md:pt-12.5 lg:pb-12 md:px-50 md:pb-20 md:items-start gap-6 md:gap-25 items-center lg:max-w-430">
        <div className="pt-5 md:pt-0 gap-2 w-82.5 h-42.75 md:w-170 flex-1 ">
          ...
          <div className="text-[16px] text-text-black tracking-[3%] font-albert font-normal md:text-[18px]">{messages?.[sectionTitle as string]?.text}</div>
        </div>
