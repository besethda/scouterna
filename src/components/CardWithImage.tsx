...
const CardWithImage = ({ sectionTitle, logo, image }: CardWithImageProps) => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row lg:px-22 w-full lg:min-w-180 pt-5 px-4 pb-10 md:flex md:pt-12.5 md:pb-8 lg:pb-12 lg:items-start gap-6 md:gap-25 lg:max-w-430">
        <div className="pt-5 md:pt-0 gap-2 h-fit flex-1 ">
          <div className="flex gap-2 items-center ">
            <p className="h-4.25 uppercase font-bold text-acc tracking-[1.5px] text-text-blue md:text-acc-desktop ">{messages?.[sectionTitle as string]?.headline}</p>
