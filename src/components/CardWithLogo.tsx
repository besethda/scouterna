...
const CardWithLogo = ({ image, sectionTitle, isH1 = false, logoTopRight = false }: CardWithLogoProps) => {
  ...
  return (
    <div className="w-full flex flex-col mx-4 pb-10 md:pt-12.5 md:pb-20 md:items-start md:gap-25 items-center lg:max-w-[var(--max-w-laptop)] 2xl:max-w-[var(--max-w-desktop)] bg-bg-blue">
