...
const ScoutInfo = () => {
  ...
  return (
    <div className="bg-white flex flex-col 2xl:items-start 2xl:text-left py-8 px-4 mx-4 rounded-3xl shrink-0 lg:w-[848px] lg:px-10 lg:py-8 xl:w-[1265px] 2xl:w-[1544px] ">
