...
const ScoutInfo = () => {
  ...
  return (
    <div className="relative bg-white flex flex-col 2xl:items-start 2xl:text-left py-8 md:mb-15 md:mt-5 px-4 mx-4 lg:mx-auto rounded-3xl shrink-0 lg:max-w-[var(--max-w-laptop)] xl:mx-auto 2xl:max-w-[var(--max-w-desktop)] md:px-10 shadow-xl">
