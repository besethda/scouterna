  ...
  return (
    <div className={`${mobile ? "mr-4 lg:hidden " : ""}`}>
      <div className="">
        ...
        <div ref={box} onClick={()=>setAlertShown(false)} className={`fixed lg:min-w-100 lg:max-w-180 lg:max-h-80 mr-[4vw] lg:mr-2 w-[92vw] max-h-[50vh] overflow-scroll z-40 bg-bg-white/60 backdrop-blur-xl p-5 cursor-pointer
