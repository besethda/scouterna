  ...
  return (
    <div className="">
      <div className="">
        ...
        {alerts.notifications.type === "notis" && <Image className="hover:brightness-90 active:brightness-75 cursor-pointer duration-100" onClick={()=> setAlertShown(!alertShown)} src={"/notis.svg"} alt={"obs"} width={32} height={32}/>}
