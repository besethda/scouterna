...
const Activities = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-bg-white px-4 py-8 mx-4 mb-10 rounded-3xl md:mb-20 lg:max-w-[850px] xl:max-w-[980px] lg:mx-auto lg:px-10 2xl:max-w-[1200px]">
