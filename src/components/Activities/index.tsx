...
const Activities = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-bg-white lg:px-10 px-4 py-8 mx-4 mb-10 rounded-3xl md:mb-20 lg:max-w-[var(--max-w-laptop)] xl:mx-auto 2xl:max-w-[var(--max-w-desktop)]">
