...
const ContactAddress = ({title, text01,text02,text03,text04,info01,info02,info03,info04}:ContactProps) => {
    return (
        <div className="mx-4 md:mx-4 lg:mx-0 px-4 md:px-4 lg:px-11 py-8 md:py-8 rounded-3xl bg-primary text-text-white text-base md:text-h5-desktop flex flex-col gap-2 items-start shadow-xl">
