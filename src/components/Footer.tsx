            ...
            <div className='flex flex-col gap-2.5 xl:flex xl:flex-row xl:justify-around xl:w-[90%] xl:mx-auto'>
                ...
                <div className='xl:flex xl:flex-col gap-5 hidden xl:flex-1'>
                    ...
                    <div className='flex gap-2.5 leading-none'>
                        ...
                        <Link href="https://www.scouternasfolkhogskola.se/" target='_blank' className="text-body-desktop xl:text-lg">{messages?.footer?.footer_school}</Link>
                    </div>
                    <div className='flex gap-2.5 leading-none'>
                        <Image src={bagIcon} alt='bag icon' className='w-4 h-4 xl:w-5 xl:h-6' />
                        <Link href="https://www.scoutshop.se/" target='_blank' className="text-body-desktop xl:text-lg">{messages?.footer?.footer_shop}</Link>
                    </div>
                    <div className='flex gap-2.5 leading-none'>
                        <Image src={keyIcon} alt='key icon' className='w-4 h-4 xl:w-5.5 xl:h-5.5' />
                        <Link href="https://www.scoutnet.se/f/login" target='_blank' className="text-body-desktop xl:text-lg">Scoutnet</Link>
                    </div>
                </div>
